		...
		<div className={s.container}>
			...
			<table className={s.table}>
				<tbody>
					...
					<tr>
						<td>
							Суму платежу за розрахунковий період [включає платіж за кредитом,
							проценти за користування кредитом, розмір платежів за супровідні послуги
							фінансової установи, кредитного посередника (за наявності) та третіх
							осіб, гривень;
						</td>
						<td>
							Графік погашення: <br />
					...
					<tr>
						<td>
							Загальна кількість платежів, уключаючи періодичність їх сплати та/або
							дати сплати.
						</td>
						<td>
							Одноразово 1 (один) платіж, в сумі {totalDebt} грн, в дату яка відповідає
							даті повернення кредиту ({finalDate})
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td>
							Перелік складових загальної вартості кредиту (згідно зі строковістю,
							зазначеною в договорі про споживчий кредиту розрізі сум і дат погашення
							основного боргу, сплати процентів за користування кредитом, вартості всіх
							супровідних послуг, кредитного посередника (за наявності) та третіх осіб
							за кожним платіжним періодом або гіперпосилання на графік платежів)
						</td>
						<td>
							{moneyAmount} грн – тіло кредиту;
							<br />
