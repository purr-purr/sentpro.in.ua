	...
	return (
		<>
			...
			<article className={s.alert}>
				...
				<p>
					Зазначаючи реквізити електронного платіжного засобу (платіжної картки) на
					цьому вебсайті для здійснення будь-якої дії, як-от
					авторизації/ідентифікації особи, заповнення відповідної реєстраційної форми
					(реєстрації на вебсайті), додавання платіжної картки в особистому кабінеті
					(активація/реєстрація платіжної картки), для безготівкового перерахування
					коштів на рахунок, списання коштів із рахунку (погашення кредиту),
					позичальник усвідомлює,{' '}
					<b>що ці реквізити зберігатимуться кредитодавцем</b> або особою, з якою в
					кредитодавця є договірні відносини,{' '}
					<b>
						та можуть використовуватися для списання коштів з рахунку для погашення
						вимог за договором про споживчий кредит.
					</b>
				</p>
				<br />
				<p>
					У разі настання такого списання позичальник має право в односторонньому
					порядку відмовитися або припинити списання коштів у визначеному договором
					порядку
				</p>
			</article>
		</>
